	...
	render() {
		...
		var menuList = menus.map(function (menu) {
			return (
				<div key={menu.Id}>
					<b>{menu.Name}</b><br />
					<img style={{ width: '100px', float: 'left', margin: '5px' }} src={"/Img/" + menu.Picture} /><p>{menu.Description}</p>
		...
		if (this.state.orderPlaced)
			cart.innerHTML = "<div className='orderPlaced'>Order Placed successfully.</div>";
					...
					<div id="wrapper">
						...
						<div id="dvcart">
							<div className='myCart'>
								My Cart <button id='btnToggle' className="smartButton" onClick={this.toggleView.bind(this)}>+</button>
							</div>
							<div id="cartContent">
								{myItems}
							</div>
